...
#: Two classes. Everything shares one clearance requirement - the highest
#: potential anywhere on this board is the input rail, and there is no
...
#: The nets in the Bus class: the two conductors that leave for the cable.
